...
This extension provides [Verilog], [Verilog-AMS], [SystemVerilog], [VHDL], and [VHDL-AMS] support to [Zed] via LSP using the [Vermilion] language server, linter, and code formatter.
