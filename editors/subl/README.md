# Vermilion LSP - Sublime Text 4

This extension provides [Verilog], [Verilog-AMS], [SystemVerilog], [VHDL], and [VHDL-AMS] support to [Sublime Text 4] via [Sublime LSP] using the [Vermilion] language server, linter, and code formatter.
