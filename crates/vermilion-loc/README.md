...
Location, position, and context types for [Vermilion]'s [`vermilion-diagnostics`], [`vermilion-lang`], and the various language frontend crates.
...
[`vermilion-diagnostics`]: ../vermilion-diagnostics/
[`vermilion-lang`]: ../vermilion-lang/
