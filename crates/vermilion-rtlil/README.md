...
> [!WARNING]
> This is currently a stub crate for eventual RTLIL support in Vermilion, it is not the focus until the main
> HDL language support is implemented and working well enough to add ancillary support for RTLIL files.

This crate provides support for [Yosys RTLIL] for [Vermilion] and [Alembic].
...
[Alembic]: https://codeberg.org/shrine-maiden-heavy-industries/Vermilion/src/branch/main/crates/alembic
[Yosys RTLIL]: https://yosyshq.readthedocs.io/projects/yosys/en/latest/appendix/rtlil_text.html
