...
pub static VERILOG_01_BUILTIN_SYSFUNC_MAP: phf::Map<&'static str, BuiltinSysFunc> = phf_map! {
	...
	"vcdclose" => BuiltinSysFunc::VcdClose,
	"write" => BuiltinSysFunc::Write,
	"writeb" => BuiltinSysFunc::WriteB,
	"writeh" => BuiltinSysFunc::WriteH,
	"writeo	" => BuiltinSysFunc::WriteO,
...
pub static VERILOG_01_BUILTIN_SYSFUNC_SET: phf::Set<&'static str> = phf_set! {
	...
	"dist_uniform",     "fmonitoro",      "nokey",          "sreadmemb",    "vcdclose",
	"dumpall",          "fopen",          "nolog",          "sreadmemh",    "write",
	"dumpfile",         "fread",          "printtimescale", "sscanf",       "writeb",
	"dumpflush",        "fscanf",         "q_add",          "stime",        "writeh",
	"dumplimit",        "fseek",          "q_exam",         "stop",         "writeo",
...
pub static VERILOG_05_BUILTIN_SYSFUNC_SET: phf::Set<&'static str> = phf_set! {
	...
	"dist_chi_square",  "finish",         "monitorh",   "sin",            "vcdclose",
	"dist_erlang",      "floor",          "monitoro",   "sqrt",           "write",
	"dist_exponential", "fmonitor",       "monitoroff", "sreadmemb",      "writeb",
	"dist_normal",      "fmonitorb",      "monitoron",  "sreadmemh",      "writeh",
	"dist_poisson",     "fmonitorh",      "nokey",      "sscanf",         "writeo",
...
pub static SYSTEM_VERILOG_05_BUILTIN_SYSFUNC_SET: phf::Set<&'static str> = phf_set! {
	...
	"coverage_merge",   "fflush",           "log10",            "shortrealtobits", "vcdclose",
	"coverage_save",    "fgetc",            "low",              "showscopes",      "warning",
	"dimensions",       "fgets",            "monitor",          "showvars",        "write",
	"display",          "finish",           "monitorb",         "signed",          "writeb",
	"displayb",         "floor",            "monitorh",         "sin",             "writeh",
	"displayh",         "fmonitor",         "monitoro",         "size",            "writeo",
...
pub static SYSTEM_VERILOG_09_BUILTIN_SYSFUNC_SET: phf::Set<&'static str> = phf_set! {
	...
	"displayo",           "fwrite",         "rose",             "vcdclose",
	"dist_chi_square",    "fwriteb",        "rose_gclk",        "warning",
	"dist_erlang",        "fwriteh",        "rtoi",             "write",
	"dist_exponential",   "fwriteo",        "sampled",          "writeb",
	"dist_normal",        "get_coverage",   "save",             "writeh",
	"dist_poisson",       "getpattern",     "scale",            "writememb",
	"dist_t",             "high",           "scope",            "writememh",
	"dist_uniform",       "hypot",          "sdf_annotate",     "writeo",
};
...
pub static SYSTEM_VERILOG_12_BUILTIN_SYSFUNC_SET: phf::Set<&'static str> = phf_set! {
	...
	"display",            "ftell",          "rising_gclk",          "vcdclose",
	"displayb",           "future_gclk",    "rose",                 "warning",
	"displayh",           "fwrite",         "rose_gclk",            "write",
	"displayo",           "fwriteb",        "rtoi",                 "writeb",
	"dist_chi_square",    "fwriteh",        "sampled",              "writeh",
	"dist_erlang",        "fwriteo",        "save",                 "writememb",
	"dist_exponential",   "get_coverage",   "scale",                "writememh",
	"dist_normal",        "getpattern",     "scope",                "writeo",
...
pub static VERILOG_AMS_09_BUILTIN_SYSFUNC_SET: phf::Set<&'static str> = phf_set! {
	...
	"dist_t",               "fstrobeo",       "reset_count",       "vcdclose",
	"dist_uniform",         "ftell",          "reset_value",       "vflip",
	"driver_count",         "fwrite",         "restart",           "vt",
	"driver_delay",         "fwriteb",        "rewind",            "warning",
	"driver_next_state",    "fwriteh",        "rtoi",              "write",
	"driver_next_strength", "fwriteo",        "save",              "writeb",
	"driver_state",         "getpattern",     "scale",             "writeh",
	"driver_strength",      "hflip",          "scope",             "writeo",
	"driver_type",          "hypot",          "sdf_annotate",      "xposition",
	"dumpall",              "incsave",        "sformat",           "yposition",
...
pub static VERILOG_AMS_23_BUILTIN_SYSFUNC_SET: phf::Set<&'static str> = phf_set! {
	...
	"dist_uniform",         "ftell",          "reset_count",       "vcdclose",
	"driver_count",         "fwrite",         "reset_value",       "vflip",
	"driver_delay",         "fwriteb",        "restart",           "vt",
	"driver_next_state",    "fwriteh",        "rewind",            "warning",
	"driver_next_strength", "fwriteo",        "rtoi",              "write",
	"driver_state",         "getpattern",     "save",              "writeb",
	"driver_strength",      "hflip",          "scale",             "writeh",
	"driver_type",          "hypot",          "scope",             "writeo",
	"dumpall",              "incsave",        "sdf_annotate",      "xposition",
	"dumpfile",             "info",           "sformat",           "yposition",
};
