...
This crate provides common diagnostic (Error/Lint reporting, etc.) infrastructure for [Vermilion] and [Cinnabar], as well as all of the various other language frontend crates.
