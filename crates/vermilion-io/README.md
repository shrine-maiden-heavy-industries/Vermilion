...
This crate provides I/O abstractions for [Vermilion] and [Cinnabar], allowing for things such as transparent compressed file access and automatic memory-mapping of large files.
