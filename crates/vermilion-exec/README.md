...
> [!WARNING]
> This crate is only intended for use with [Vermilion] and it's associated crates, it's not recommended that
> other projects use it.

This crate provides common executable entrypoint machinery for [Vermilion], [Cinnabar], [Alembic], and other associated executable crates.
