...
> [!WARNING]
> This is an internal Vermilion tool

This crate is an [mdBook] preprocessor for use in the [Vermilion] and [Cinnabar]. It's used to generate the pages for the configuration and workspace files, as well as the diagnostics with all the most up-to-date values.
