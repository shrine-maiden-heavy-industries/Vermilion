...
use crate::{LanguageStd, sdc::lang::tokenizer::token::Token};

pub mod token;

pub struct SdcTokenizer {
...
impl SdcTokenizer {
	pub fn new(standard: LanguageStd, file: AtomicByteTendril) -> eyre::Result<SdcTokenizer> {
...
impl Iterator for SdcTokenizer {
